...
LEN def 0x40 ; Maximum possible length of the input string
...
; Check if printable
    load r2, #SPC               ; Load first printable character
    sub r2, r2, r0              ; R2 becomes > 0 if character is not printable
    jgz r2, $skip_keyboard      ; If the character is not printable, skip
