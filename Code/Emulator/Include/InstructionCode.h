...
namespace std {
	template <> struct hash<bnssemulator::InstructionCode> {
		size_t operator()(const bnssemulator::InstructionCode & code) const;
	};

	inline size_t hash<bnssemulator::InstructionCode>::operator()(const bnssemulator::InstructionCode & code) const {
